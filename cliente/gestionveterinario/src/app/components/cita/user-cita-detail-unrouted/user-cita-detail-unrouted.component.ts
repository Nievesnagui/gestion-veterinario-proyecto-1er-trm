...
@Component({
  selector: 'app-user-cita-detail-unrouted',
  templateUrl: './user-cita-detail-unrouted.component.html',
  styleUrls: ['./user-cita-detail-unrouted.component.css']
})
export class UserCitaDetailUnroutedComponent implements OnInit {
